...
<figcaption>
  <b>Figure 1.</b> Word cloud constructed from the 100 most frequently used words used across all chapters of the BugBook.
</figcaption>
...
<figcaption>
  <b>Figure 2.</b> Interactive network of collaboration patterns. Use scroll to zoom in and out, and click and drag a node to explore and expand the network.
</figcaption>
...
The geographical distribution (<b>Figure 3</b>) of people that have contributed to the BugBook project clearly shows a Europe-centered focus. The majority of authors are located in `r country_freq$Country[1]`, `r country_freq$Country[2]`, and `r country_freq$Country[3]`. The institution with the highest number of contributions was `r institution_freq$Institution[1]`. 
...
<figcaption>
  <b>Figure 3.</b> Interactive map showing the geographical distribution of the people that contributed to the BugBook.
</figcaption>
...
<figcaption>
  <b>Figure 4.</b> Overview of selected statistics. <b>A.</b>  Timeline of chapter submissions, acceptances, and online publications. <b>B.</b> Institutional rankings based on the number of contributions to BugBook chapters (Top 10). <b>C.</b> Number of authors per chapter.
</figcaption>
...
The raw data used in this post can be downloaded [here](https://github.com/tklammsteiner/bugbook/raw/dad477f8be674a8cbb0b8a0aa413551127c03525/data/bugbook_data.xlsx). Feel free to use, adapt, and share this work in any way you like.
